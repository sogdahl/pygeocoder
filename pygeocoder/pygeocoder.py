...
# Updated/fixed by Steven Ogdahl
#
...
class Geocoder(object):
    ...
    def get_data(self, params={}):
        ...
        if self and self.client_id:
            params['client'] = str(self.client_id)
    ...
    def add_signature(self, request):
        ...
        url = urlparse.urlparse(request.url + urllib.urlencode(request.params))
        signature = hmac.new(decoded_key, url.path + "?" + url.query, hashlib.sha1)
